	...
	<div id="content" class="webdev-content clearfix">
		...
		<div id="inner-content">
				...
				<div id="main" class="first clearfix" role="main">
					...
					<p class="webdev-intro">This a small selection of projects I have worked on recently.</p>
					...
					<div class="website threecol">
						<a href="https://fumaca.pt" rel="external" target="_blank"><img src="<?php echo $templateURL; ?>/img/webdev-fumaca-s.jpg" alt="Gustavo Ciríaco is a multi-faceted artist. Performer, dancer, composer, director. Living between Brazil and Portugal."></a>
						<p>
							Fumaça is a progressive, community-supported podcast that produces slow-journalism pieces. The website hosts interviews, articles and podcast episodes, besides driving subscriptions and newsletter signups.
						</p>
						<p class="website-url">
							<svg viewBox="0 0 24 24"><path d="m0 0h24v24h-24z" opacity="0"/><g><path d="m8 12a1 1 0 0 0 1 1h6a1 1 0 0 0 0-2h-6a1 1 0 0 0 -1 1z"/><path d="m9 16h-1.79a4.13 4.13 0 0 1 -4.21-3.63 4 4 0 0 1 4-4.37h2a1 1 0 0 0 0-2h-1.79a6.15 6.15 0 0 0 -6.16 5.21 6 6 0 0 0 5.95 6.79h2a1 1 0 0 0 0-2z"/><path d="m23 11.24a6.16 6.16 0 0 0 -6.24-5.24h-1.51c-.81 0-1.25.45-1.25 1a1 1 0 0 0 1 1h1.79a4.13 4.13 0 0 1 4.21 3.63 4 4 0 0 1 -4 4.37h-2a1 1 0 0 0 0 2h2a6 6 0 0 0 6-6.76z"/></g></svg>
					...
					<div class="website threecol">
						...
						<p>
							Lusithand Devices make bespoke, high-quality bass pre-amps and pedals and through their e-commmerce will <strong>soon</strong> be able to take orders from musicians and music retail stores.
						</p>
						<p class="website-url">
							<svg viewBox="0 0 24 24"><path d="m0 0h24v24h-24z" opacity="0"/><g><path d="m8 12a1 1 0 0 0 1 1h6a1 1 0 0 0 0-2h-6a1 1 0 0 0 -1 1z"/><path d="m9 16h-1.79a4.13 4.13 0 0 1 -4.21-3.63 4 4 0 0 1 4-4.37h2a1 1 0 0 0 0-2h-1.79a6.15 6.15 0 0 0 -6.16 5.21 6 6 0 0 0 5.95 6.79h2a1 1 0 0 0 0-2z"/><path d="m23 11.24a6.16 6.16 0 0 0 -6.24-5.24h-1.51c-.81 0-1.25.45-1.25 1a1 1 0 0 0 1 1h1.79a4.13 4.13 0 0 1 4.21 3.63 4 4 0 0 1 -4 4.37h-2a1 1 0 0 0 0 2h2a6 6 0 0 0 6-6.76z"/></g></svg>
					...
					<div class="website threecol">
						<div id="your-site-here">
							<p><a href="/contact">Your Site Here</a></p>
						</div>
						<p>
				...
				<p>Take a look at <a href="https://fredrocha.net/wp-content/uploads/2022/09/Fred-Rocha-Web-Engineer-with-Eye-for-Design-September-2022.pdf">my CV</a> to have a better sense of the technologies used.</p>
